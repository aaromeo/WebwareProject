...
app.get('/events', function (req, res) {
  ...
  var compiled = _.template(
    "<div class='events'>" +
      ...
      "<input id='like<%= index %>' type='button' name='new' value='Upvote' onclick='addLike(<%= index %>);'>"+
      "<input id='dislike<%= index %>'type='button' name='new1' value='Downvote' onclick='addDislike(<%= index %>);'>"+
    "</div>");
